...
if (!isset($_SESSION['allowed_step']) || $_SESSION['allowed_step'] < 3) {
        ...
        if (empty($error_msg)) {
            if ($ex_meas_row) {
                ...
                if ($stmt = $conn->prepare($sql)) {
                    ...
                    if ($stmt->execute()) {
                        $_SESSION['allowed_step'] = max($_SESSION['allowed_step'] ?? 3, 4);
                        header("Location: form4_member_payment_details.php");
                        exit;
                    } else {
    ...
    <div class="container">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" name="chest_nipple_line" class="form-input" placeholder="in inches"
                                step="0.1" value="<?php echo htmlspecialchars($chest); ?>" required>
                            <img src="../icons/ruler-solid-full.svg" class="fa-solid fa-ruler input-icon icon-blue">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" name="waist_navel_line" class="form-input" placeholder="in inches"
                                step="0.1" value="<?php echo htmlspecialchars($waist); ?>" required>
                            <img src="../icons/tape-solid-full.svg" class="fa-solid fa-tape input-icon icon-green">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <img src="../icons/ruler-combined-solid-full.svg"
                                class="fa-solid fa-ruler-combined input-icon icon-purple">
                        </div>
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            <input type="number" name="thigh_mid" class="form-input" placeholder="in inches" step="0.1"
                                value="<?php echo htmlspecialchars($thigh); ?>" required>
                            <img src="../icons/ruler-vertical-solid-full.svg"
                                class="fa-solid fa-ruler-vertical input-icon icon-yellow">
                        </div>
                    </div>
                    <div class="input-group full-width">
                        <h3 class="section-title mt-30 mb-4" style="margin-bottom: 4px;">
                            <img src="../icons/camera-solid-full.svg"
                                class="fa-solid fa-camera mr-10 header-icon-orange">
                            Progress Photos
                        </h3>
                        <p style="font-size: 13px; color: #6B7280; margin-bottom: 25px; line-height: 1.5;">
                            ...
                            <span style="color: #F25C2A; font-weight: 600;">(Max 2MB per photo in jpg/png format
                                only!)</span>
                        </p>
                    </div>
            ...
            <div class="card-footer footer-spaced">
                <a href="form2_member_metrics.php" class="btn btn-secondary">Back to metrics</a>
