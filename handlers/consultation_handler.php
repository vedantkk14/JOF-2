...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $addressHtml = '<div style="font-size:9px; color:#555; line-height:1.2; margin:0;">Aurelia, Pancard Road, Baner, Pune-411045, Maharashtra<br>iglmembershipid@gmail.com</div>';
