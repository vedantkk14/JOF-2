...
<head>
    ...
    <title>JOF INDIA | Login Page</title>
    ...
    <style>
        ...
        .login-success-icon {
            ...
            filter: brightness(0) invert(1) !important; /* Makes the icon pure white */
...
<div class="success-overlay" id="successPopup">
    ...
    <div class="auth-container">
        ...
        <div class="visual-side">
            ...
            <p class="brand-quote">
                Get the best workouts & excercise plans tailored for you at JOF Fitness Center!
            </p>
        </div>
    ...
    <script>
        ...
        // 'event.persisted' is true if the browser pulled this page out of its frozen memory cache
            if (event.persisted) {
                // Hide the spinning modal just in case
                document.getElementById('successPopup').classList.remove('active');
                // Force the page to reload, which triggers our PHP bouncer at the top of the file
        ...
        form.addEventListener('submit', function (e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    popupMessage.innerText = "Redirecting to dashboard...";
