...
<head>
    ...
    <style>
        ...
        /* never skipped past while filling out the rest of the form.              */
        .visibility-box {
        ...
        <main class="main-content">
            ...
            <div class="form-container">
                ...
                <form class="membership-form" id="membershipForm" action="../handlers/membership_handler.php"
                    ...
                    <!-- Visibility to members (highlighted — defaults to hidden until you're ready) -->
                    <div class="visibility-box">
                        <div class="vb-text">
                            <span class="vb-icon"><img src="../icons/eye-solid-full.svg" alt="visibility"></span>
                            <div>
                                <p class="vb-title">Show this plan to members?</p>
                                <p class="vb-sub">When "Yes", it appears in members' app under their Membership section so they can browse and request it. Starts hidden so you can finish setting it up first.</p>
                            </div>
                        </div>
                        <div class="vis-toggle">
                            <input type="radio" name="is_public" id="visNo" value="no" checked>
                            <label for="visNo" class="opt-no">No</label>
                            <input type="radio" name="is_public" id="visYes" value="yes">
