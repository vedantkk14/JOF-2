...
if (empty($invoices)) {
    die("Error: No invoices found for this member.");
}

// 2b. Fetch Installment History
...
$inst_stmt->bind_param("i", $member_id);
$inst_stmt->execute();
...
<head>
    ...
    <title>All Invoices | JOF INDIA</title>
    <style>
        body {
...
<body>
    ...
    <div class="footer-actions">
        <p style="margin-bottom: 15px; font-weight: bold; font-size: 18px;">All Invoices for
            <?= htmlspecialchars($invoices[0]['full_name'] ?? 'Member') ?>
        </p>
        <div>
                ...
                <tr>
                    <td width="60%" valign="top">
                        ...
                        <span style="font-size:11px; color:#555;">Aurelia, Pancard Road, Baner, Pune-411045,
                            Maharashtra<br>vrishabhchadchan1@gmail.com</span>
                    </td>
