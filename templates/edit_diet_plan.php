...
<body class="page-create_diet_plan">
        ...
        <div class="card-body">
            ...
            <div style="margin: 0 0 18px; border: 1px dashed #F25C2A; border-radius: 12px; background: #FFF7ED;">
                ...
                <div id="gptImportBody" style="display:none; padding:0 16px 16px;">
                    <p style="font-size:12.5px; color:#92400E; margin:0 0 8px;">Paste the diet plan text from ChatGPT, or upload the plan as a PDF &mdash; then click <b>Fill the form</b>. Fields are only filled in &mdash; nothing is saved until you press Save Changes.</p>
    ...
    <script>
        ...
        function gptFillForm() {
            ...
            setGptResult(filled
                ? ('✓ Filled ' + filled + ' field(s). Review everything, then Save Changes.')
