...
// 3. Prepare Variables — CASH invoice serial number (independent sequence)
    ...
    <div class="invoice-container">
        ...
        <header class="invoice-header">
            ...
            <div class="header-details">
                ...
                <span class="payment-mode-badge">💵 Cash Payment</span>
            </div>
        </header>
