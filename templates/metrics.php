    ...
    <div class="container">
        ...
        <form action="" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <img src="../icons/utensils-solid-full.svg" class="fa-solid fa-utensils input-icon icon-red">
                        </div>
                    </div>
            ...
            <div class="card-footer footer-spaced flex-between">
                <?php if ($is_admin): ?>
                    <a href="add_member.php?back=1" class="btn btn-secondary btn-border">Back to
                        member info</a>
                <?php
else: ?>
                    <a href="add_member.php?back=1" class="btn btn-secondary btn-border">Back to
