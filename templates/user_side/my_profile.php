...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!hash_equals($_SESSION['_csrf_token'] ?? '', $_POST['_csrf_token'] ?? '')) {
        ...
        if (!$errors) {
            ...
            header('Location: my_profile.php?saved=1' . ($notice ? '&notice=' . urlencode($notice) : ''));
            exit;
        }
    }
}
...
<head>
    ...
    <title>JOF India — My Profile</title>
...
<body>
    <div class="shell" id="shell">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-group">
                ...
                <a class="nav-item active" href="my_profile.php">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round">
            ...
            <div class="topbar">
                ...
                <div class="topbar-right">
                    <div class="profile-chip">
                        ...
                        <div>
                            <div class="profile-name"><?= htmlspecialchars($acct_name ?: 'Member', ENT_QUOTES, 'UTF-8') ?>
                            </div>
    ...
    <script>
        ...
        document.getElementById('discardBtn').addEventListener('click', () => { dirty = false; location.href = 'my_profile.php'; });
        ...
        if (toast) {
            ...
            if (history.replaceState) history.replaceState(null, '', 'my_profile.php');
        }
    </script>
</body>
